...
_**Note:** The diagram in the video was made by `Fable 5`, I will fable 5 artifacts and add them to the skill reference folder for smaller models to distill._
